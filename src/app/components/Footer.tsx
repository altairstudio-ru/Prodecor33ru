          ...
          <div className="w-full lg:w-auto lg:min-w-[480px]">
            {submitted ? (
              <p className="text-[#C6A96B] text-center py-4 font-medium">
                Заявка принята. Свяжемся с вами в ближайшее
                время!
              </p>
            ) : (
              <form
      ...
      <div className="py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            {/* Brand */}
            <div>
              <Logo className="h-17 w-auto text-white mb-2" />
              <p className="text-[#C6A96B] text-xs tracking-[0.15em] uppercase mb-4">
                От проекта до реализации
              </p>
              <p className="text-[#666] text-sm leading-relaxed">
                Дизайн интерьера и ремонт под ключ во Владимире
                и области
              </p>
            </div>
            ...
            {/* Nav */}
            <div>
              <h4 className="font-medium mb-4 text-xs tracking-widest uppercase text-[#555]">
                Разделы
              </h4>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <a
                  href="mailto:info@prodecor33.ru"
                  className="flex items-center gap-2.5 text-[#999] hover:text-[#C6A96B] transition-colors"
                >
              ...
              <div className="space-y-2">
                {socials.map((s) => (
                  ...
                  >
                    ...
                    <span>{s.label}</span>
                    {!s.active && (
                      <span className="ml-auto text-[0.6rem] tracking-wider uppercase text-[#3A3A3A]">
                        скоро
                      </span>
                    )}
                  </a>
